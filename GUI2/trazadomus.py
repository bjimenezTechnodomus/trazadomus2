...
class home_window:
    ...
    def __init__(self):
        ...
        self.home_screen.config(bg='#1f3d7b')
        self.home_screen.resizable(False, False)
        self.home_screen.attributes('-fullscreen', True)
    ...
    def main_window(self, closing_window_name):
        ...
        self.main_widnow_frame = Frame(master=self.home_screen, width=1280, height=720,bg='#1f3d7b')
        self.main_widnow_frame.pack()

        img = Image.open("/home/trazadomus/GUI/images/image_1.png")
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.main_widnow_frame, image=imgrez1, background="#1f3d7b",borderwidth = 0)
        img_button.pack(pady=(150,0))

        scan_img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/scan 1.png"))
        scan_img_button = Label(self.main_widnow_frame, image=scan_img, background="#1f3d7b",borderwidth = 0)
        scan_img_button.pack(pady=(130,0))

        scaner_label = Label(self.main_widnow_frame, text='Escanea tu QR de usuario', background="#1f3d7b", fg='white',font=("Helvetica", 25, 'bold'))
    ...
    def crearLote(self):
        ...
        if(self.currentEsteri!=""):
            if(len(self.loteList)>0):
                try:
                    connection = mariadb.connect(host='localhost',database='trazadomus',user='equipo',password='trazadomus')
                    connection.autocommit = True
                    cursor = connection.cursor()
                    e = datetime.datetime.now()
                    today=e.strftime("%Y-%m-%d %H:%M")
                    sql = "INSERT INTO dimension_lotes (codigo,id_usuario,id_esterilizador,fecha,indicador,status,status_nube) VALUES(?,?,?,?,?,?,?)"
                    cursor.execute(sql,(self.nextLote,self.id_user,self.id_esteri,today,0,0,0))
                except mariadb.Error as e:
                    print("Error while connection2 to MariaDB", e)
                finally:
                ...
                self.alert_text.set("Agrega contenido al lote.")
        else:
            self.alert_text.set("Escanea un esterilizador.")
    ...
    def checkCandados(self):
        with open('/home/trazadomus/GUI/config/candados.json') as candados:
            dataC = json.load(candados)
            candados.close()
        self.candado1 = dataC["candado1"]    
        self.candado2 = dataC["candado2"]
                                ...
                                if nivel > 4:
                                    if pares[4] == "01":
                                        ...
                                        if self.candado2 == 1:
                                            ...
                                            self.Actualizar_lote_3_window(self.Actualizar_lote_2_screen)
    ...
    def home_window_2(self, closing_window_name):
        ...
        self.home_screen_2 = Frame(self.home_screen, height=720, width=1280, bg='#1f3d7b', relief='raised')
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.home_screen_2, image=imgrez1, background="#1f3d7b",borderwidth = 0)
        img_button.pack(pady=(150,0))

        self.user_label = Label(self.home_screen_2, text='Usuario:', background="#1f3d7b", fg='white',font=("Helvetica", 25, 'bold'))
        self.user_label.place(x=460,y=250)

        self.username = Label(self.home_screen_2, textvariable=self.user_text, background="#1f3d7b", fg='white',font=("Helvetica", 25))
        self.username.place(x=612,y=250)


        Empaquetado = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/Empaquetado.png"))
        Empaquetado_button = Label(self.home_screen_2, image=Empaquetado, background="#1f3d7b", borderwidth=0)
        Empaquetado_button.place(x=180,y=340)

        crear_lote = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/crear lote.png"))
        crear_lote_button = Label(self.home_screen_2, image=crear_lote, background="#1f3d7b", borderwidth=0)
        crear_lote_button.place(x=530,y=340)

        actualizar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/actualizar.png"))
        actualizar_button = Label(self.home_screen_2, image=actualizar, background="#1f3d7b", borderwidth=0)
    ...
    def Empaquetado_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.Empaquetado_screen, image=img, background="#1f3d7b")
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.Empaquetado_screen, image=imgrez1, background="#1f3d7b", borderwidth=0)
        img_button.place(x=50, y=40)


        Empaquetado_label = Label(self.Empaquetado_screen, text='Empaquetado', background="#1f3d7b", fg='white',
                                  font=("Helvetica", 25))
        Empaquetado_label.place(x=640, y=55)
        ...
        Regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/Regresar.png"))
        Regresar_button = Label(self.Empaquetado_screen, image=Regresar, background="#1f3d7b", borderwidth=0)
        Regresar_button.place(x=80, y=400)

        Imprimir = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/Imprimir.png"))
        Imprimir_button = Label(self.Empaquetado_screen, image=Imprimir, background="#1f3d7b", borderwidth=0)
        ...
        self.fecha_1_label.place(x=100, y=180)
        ...
        self.fecha_2_label.place(x=360, y=180)
    ...
    def Crear_lote_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.Crear_lote_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.Crear_lote_screen, image=imgrez1, background="#1f3d7b",borderwidth = 0)
        img_button.place(x=50,y=40)

        crear_lote_label = Label(self.Crear_lote_screen, text='Crear lote', background="#1f3d7b", fg='white',font=("Helvetica", 25))
        crear_lote_label.place(x=640,y=55)
        ...
        Regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar_2.png"))
        Regresar_button = Label(self.Crear_lote_screen, image=Regresar, background="#1f3d7b", borderwidth=0)
        Regresar_button.place(x=650,y=240)

        Imprimir = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/crear_2.png"))
        Imprimir_button = Label(self.Crear_lote_screen, image=Imprimir, background="#1f3d7b", borderwidth=0)
    ...
    def actualizar_lote_paquete_window(self, closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.actualizar_lote_paquete_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.actualizar_lote_paquete_screen, image=imgrez1, background="#1f3d7b", borderwidth=0)
        img_button.place(x=50, y=40)


        crear_lote_label = Label(self.actualizar_lote_paquete_screen, text='Actualizar lote o paquete', background="#1f3d7b", fg='white',
                                 font=("Helvetica", 25))
        crear_lote_label.place(x=640, y=55)
        ...
        regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar3.png"))
        ...
        lote = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/lote3.png"))
        ...
        paquete = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/paquete.png"))
    ...
    def actualizar_lote_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.actualizar_lote_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.actualizar_lote_screen, image=imgrez1, background="#1f3d7b", borderwidth=0)
        img_button.place(x=50, y=40)

        actualizar_lote_label = Label(self.actualizar_lote_screen, text='Actualizar lote', background="#1f3d7b", fg='white',
                                 font=("Helvetica", 25))
        actualizar_lote_label.place(x=640, y=55)

        label_1 = Label(self.actualizar_lote_screen, text='Elija la opción:', background="#D6D6D6", fg='black',
                                 font=("Helvetica", 20))
        label_1.place(x=180, y=220)
        
        regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar4.png"))
        regresar_button = Label(self.actualizar_lote_screen, image=regresar, background="#D6D6D6", borderwidth=0)
        regresar_button.place(x=180,y=340)

        procesado = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/procesado.png"))
        ...
        indicador = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/indicador.png"))
    ...
    def actualizar_paquete_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.actualizar_paquete_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.actualizar_paquete_screen, image=imgrez1, background="#1f3d7b", borderwidth=0)
        img_button.place(x=50, y=40)

        crear_lote_label = Label(self.actualizar_paquete_screen, text='Actualizar paquete', background="#1f3d7b", fg='white',
                                 font=("Helvetica", 25))
        crear_lote_label.place(x=640, y=55)
        ...
        regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar6.png"))
        ...
        indicador = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/indicador2.png"))
        ...
        almacen = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/almacen.png"))
        ...
        destino = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/destino.png"))
    ...
    def Actualizar_lote_2_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.Actualizar_lote_2_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.Actualizar_lote_2_screen, image=imgrez1, background="#1f3d7b",borderwidth = 0)
        img_button.place(x=50,y=40)

        actualizar_label = Label(self.Actualizar_lote_2_screen, text='Actualizar lote', background="#1f3d7b", fg='white',font=("Helvetica", 25))
        actualizar_label.place(x=640,y=55)
        ...
        Regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar5.png"))
        ...
        Imprimir = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/confirmar.png"))
    ...
    def Actualizar_lote_3_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.Actualizar_lote_3_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.Actualizar_lote_3_screen, image=imgrez1, background="#1f3d7b",borderwidth = 0)
        img_button.place(x=50,y=40)


        actualizar_label = Label(self.Actualizar_lote_3_screen, text='Actualizar lote', background="#1f3d7b", fg='white',font=("Helvetica", 25))
        actualizar_label.place(x=640,y=55)
        ...
        Regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar7.png"))
        ...
        fallido = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/fallido.png"))
        ...
        verificado = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/verificado.png"))
    ...
    def Actualizar_paquete_2_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.Actualizar_paquete_2_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.Actualizar_paquete_2_screen, image=imgrez1, background="#1f3d7b", borderwidth=0)
        img_button.place(x=50, y=40)

        actualizar_label = Label(self.Actualizar_paquete_2_screen, text='Actualizar paquete', background="#1f3d7b",
        ...
        Regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar8.png"))
        ...
        fallido = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/fallido2.png"))
        ...
        verificado = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/verificado2.png"))
        ...
        terminar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/terminar.png"))
    ...
    def Actualizar_paquete_3_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.Actualizar_paquete_3_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.Actualizar_paquete_3_screen, image=imgrez1, background="#1f3d7b", borderwidth=0)
        img_button.place(x=50, y=40)


        actualizar_label = Label(self.Actualizar_paquete_3_screen, text='Actualizar paquete', background="#1f3d7b",
                                 fg='white', font=("Helvetica", 25))
        actualizar_label.place(x=640, y=55)
        ...
        Regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar9.png"))
        Regresar_button = Label(self.Actualizar_paquete_3_screen, image=Regresar, background="#D6D6D6", borderwidth=0)
        Regresar_button.place(x=230, y=400)

        confirmar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/confirmar2.png"))
        fallido_button = Label(self.Actualizar_paquete_3_screen, image=confirmar, background="#D6D6D6", borderwidth=0)
        fallido_button.place(x=530, y=400)

        terminar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/terminar2.png"))
    ...
    def Actualizar_paquete_4_window(self,closing_window_name):
        ...
        # img = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/images/image_1.png"))
        # img_label = Label(self.Actualizar_paquete_4_screen, image=img, background="#1f3d7b")
        # img_label.pack(pady=(50,0))
        ...
        imgrez = img.resize((547,68), Image.ANTIALIAS)
        imgrez1 = ImageTk.PhotoImage(imgrez)
        img_button = Label(self.Actualizar_paquete_4_screen, image=imgrez1, background="#1f3d7b", borderwidth=0)
        img_button.place(x=50, y=40)


        crear_lote_label = Label(self.Actualizar_paquete_4_screen, text='Actualizar paquete', background="#1f3d7b",
                                 fg='white', font=("Helvetica", 25))
        crear_lote_label.place(x=640, y=55)
        ...
        Regresar = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/regresar10.png"))
        Regresar_button = Label(self.Actualizar_paquete_4_screen, image=Regresar, background="#D6D6D6", borderwidth=0)
        Regresar_button.place(x=650, y=240)

        Imprimir = ImageTk.PhotoImage(Image.open("/home/trazadomus/GUI/QRs/confirmar3.png"))
